function Projects() {
  ...
  rel="noopener noreferrer">
      ...
      <div>
        ...
        <p>I have developed a responsive personal portfolio website using React to showcase my technical skills, projects, and experience in web development. The website is designed with a clean and user-friendly interface to effectively present my work and provide easy contact access for collaboration opportunities</p>
      <a href="https://github.com/sathya19-git/personal-portfolio.git"
      >
        View Code
        </a>
      </div>
